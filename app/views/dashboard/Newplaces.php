        ...
        <div class="row">
            ...
            <div class="col-md-10" style="background: white; margin-top: 20px;">
                <div class="row">
                    ...
                    <div class="col-md-6"><h3>New Place</h3></div>

                </div>
                <div class="row">
                    <form name="newplace" action="<?php echo URL.'newplaces/create'; ?>" method="post" class="form-group" enctype="multipart/form-data">
                       <div class="form-group">
                            <label>Placename</label><input type="text" placeholder="place name" class="form-control" name="pname" required>
                        </div>
                      <div class="form-group">
                            <label>Place Description</label>
                            <textarea placeholder="place description" class="form-control" name="pdesc"></textarea>
                        </div>
                          <div class="form-group">

                ...
                <div class="panel panel-info">
                 ...
                 <div class="col-md-10" style="background: #fff">
                        ...
                        <?php foreach ($this->place as $places) {?>
                            ...
                            <form name="editplace" action="<?php echo URL; ?>editplace/update" method="get" class="form-group" enctype="multipart/form-data">
                                
                                <div class="form-group">
                                    <input type="hidden" name="pid" value="<?php echo($places[0]); ?>">
                                    <br>

                                    <label>Placename</label><input type="text" class="form-control" name="pname"  value="<?php echo($places[1]); ?>" >
                                </div>
                                <div class="form-group">
                                    <label>Place Description</label>
                                    <textarea  class="form-control" name="pdesc"><?php echo($places[2]); ?></textarea>
                                </div>
...
<script>
   ...
   var f = document.forms['editplace'];
   f.pic.value =path;
   }
</script>
<?php

...
//                        }
                        ...
                        <?php foreach ($this->trans as $transport) {?>
                            ...
                            <form name="edittransport" action="<?php echo URL.'edittransport/update';?>" method="get" class="form-group" enctype="multipart/form-data">
                                
                                <div class="form-group">
                                    <input type="hidden" name="transportid" value="<?php echo($transport[0]); ?>">
                                    <br>

                                    <label>TransportName</label><input type="text" class="form-control" name="tname"  value="<?php echo($transport[1]); ?>" >
                                </div>
                                <div class="form-group">
                                    <label>Contact</label>
                                    <input type="number" class="form-control" name="contact" value="<?php echo($transport[2]); ?>">
                                </div>
                                <div class="form-group">
                                    <label>NumberPlate</label><input type="text" class="form-control" name="nplate" value="<?php echo($transport[3]); ?>">
                                </div>
                                <div class="form-group">
                                    <label>DepartureSpot</label><input type="text" class="form-control" name="spot" value="<?php echo($transport[6]); ?>">
                                </div>
                                <div class="form-group">
                                    <label>Price</label><input type="text" class="form-control" name="price" value="<?php echo($transport[7]); ?>">
                                </div>
...
<script>
   ...
   var f = document.forms['edittransport'];
   f.pic.value =path;
   }
</script>
 <?php

<html>
	...
	<nav class="navbar">
        ...
        <section class="site-section">
            <div class="well">
                <h2 class="text-center"> Transport Booking</h2>
                <?php
                $rand =rand(100000,999999);
         
                foreach($this->trans as $transport){?>
                <button class="btn btn-info"> TransID: <?php echo $transport[0];?></button>
                    
                
                <form action="<?php echo URL;?>success?id=<?php echo $transport[0]; ?>" class="form-group" method="post">
                   ...
                   <div class="form-group">
                    ...
                    <input type="text" name="tname"  value="<?php echo $transport[1];?>" class="form-control" readonly>
                    </div>  
                   <input type="hidden" value="<?php echo $transport[8];?>" name="picture">
                   <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <button type="submit" class="btn btn-success" name="transportsubmit">Book</button></a>
